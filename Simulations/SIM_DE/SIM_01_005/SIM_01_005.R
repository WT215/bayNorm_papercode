...
#set mean BETA to be 10% and 5% in each group respectively
...
save.image("E:/RNAseqProject/SIMULATION/SIM_01_005/SIM_01_005.RData")
...
#save(scnorm_out_ori,scnorm_out,M_scnorm,T_scnorm,file="E:/RNAseqProject/SIMULATION/SIM_01_005/SIM_01_005_SCnorm.RData")
...
#save(saver_temp1,saver_temp2,saver_out,M_saver,M_saver10,saver_array1,saver_array2,file="E:/RNAseqProject/SIMULATION/SIM_01_005/SIM_01_005_saver_BETA.RData")

#scImpute####
library(scImpute)
scimpute_fun(Data=RAW_DAT,Data_name='DE_sim_01_005')
scImpute_out<-readRDS("E:/RNAseqProject/SIMULATION/SIM_01_005/DE_sim_01_005scimpute_count.rds")
gr<-table(CONDITION)
...
#MAGIC####
MAGIC_SIM_01_005 <- run_magic(t(RAW_SIM_01_005))
rownames(MAGIC_SIM_01_005)<-rownames(t(RAW_SIM_01_005))
colnames(MAGIC_SIM_01_005)<-colnames(t(RAW_SIM_01_005))
MAGIC_SIM_01_005<-t(MAGIC_SIM_01_005)

M_MAGIC<-SCnorm_runMAST(Data=MAGIC_SIM_01_005,NumCells = gr)
...
save(GG_bayNorm_out,GG_mbayNorm_out,M_GG_bayNorm_out,M_GG_mbayNorm_out,auc_GG_bayNorm_out,auc_GG_mbayNorm_out,file="E:/RNAseqProject/SIMULATION/DE_GG_explore/GG_SIM_01_005.RData")
